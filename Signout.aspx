<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Signout.aspx.cs" Inherits="ff_site_Signout" %>
...
<body onload="move()">
	...
	<header style="height:100px">
		<div class="container_16">
			...
			<nav>
				<ul>
					<%--<li><a href="Default.aspx" class="current"></a></li>
					<li><a href="#"></a></li>
					<li><a href="#"></a></li>
					<li><a href="Default2.aspx"></a></li>
           ...
           <font size="32" color=black ><strong><i> Thankyou very much for being a member of Fiasco Fix !!</i></strong></font>
           </div></div>
