<%@ Page Language="C#" AutoEventWireup="true" CodeFile="temp_report.aspx.cs" Inherits="ff_site_reportform" %>
...
First Name              <font color="red">*</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <asp:TextBox ID="TextBox1" placeholder="First Name" style="border-color:black" runat="server"></asp:TextBox>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Last Name      <asp:TextBox ID="TextBox2" placeholder="Last Name" style="border-color:black" runat="server"></asp:TextBox>
 ...
 City                   <font color="red">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; * </font><asp:DropDownList ID="DropDownList1" style="border-color:black" onchange="javascript: Address(this.options[this.selectedIndex].text);" runat="server" Height="26px" Width="147px"><asp:ListItem>-City-</asp:ListItem><asp:ListItem>Islamabad</asp:ListItem><asp:ListItem>Rawalpindi</asp:ListItem><asp:ListItem>Lahore</asp:ListItem><asp:ListItem>Karachi</asp:ListItem><asp:ListItem>Peshawar</asp:ListItem></asp:DropDownList>  
&nbsp;  
<asp:RequiredFieldValidator id="RequiredFieldValidator3" runat="server"  ControlToValidate="DropDownList1"  ErrorMessage="City is a required field."  ForeColor="Red" BorderColor="Red"></asp:RequiredFieldValidator>
        <br />
...
<asp:RequiredFieldValidator id="RequiredFieldValidator2" runat="server"  ControlToValidate="TextBox3"  ErrorMessage="House no. is a required field."  ForeColor="Red" BorderColor="Red"></asp:RequiredFieldValidator>
    <br />
Street                 <font color="red">*</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <asp:TextBox ID="TextBox4" placeholder="Street" style="border-color:black" runat="server"></asp:TextBox>&nbsp;
<asp:RequiredFieldValidator id="RequiredFieldValidator7" runat="server"  ControlToValidate="TextBox4"  ErrorMessage="Street no. is required"  ForeColor="Red" BorderColor="Red"></asp:RequiredFieldValidator>
    <br />
Sector                <font color="red">*</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <asp:TextBox ID="TextBox6" placeholder="Country" style="border-color:black" runat="server"></asp:TextBox>&nbsp;
<asp:RequiredFieldValidator id="RequiredFieldValidator6" runat="server"  ControlToValidate="TextBox6"  ErrorMessage="Country is required "  ForeColor="Red" BorderColor="Red"></asp:RequiredFieldValidator>
...
<asp:RequiredFieldValidator id="RequiredFieldValidator4" runat="server"  ControlToValidate="TextBox7"  ErrorMessage="Email is required "  ForeColor="Red" BorderColor="Red"></asp:RequiredFieldValidator>   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   <asp:RequiredFieldValidator id="RequiredFieldValidator5" runat="server"  ControlToValidate="TextBox8"  ErrorMessage="Contact no. is  required "  ForeColor="Red" BorderColor="Red"></asp:RequiredFieldValidator>
...
<asp:RequiredFieldValidator id="RequiredFieldValidator8" runat="server"  ControlToValidate="TextBox7"  ErrorMessage="Disaster type is required "  ForeColor="Red" BorderColor="Red"></asp:RequiredFieldValidator>
        <br />
        <br />
 ...
 <asp:Button ID="Button2" runat="server" Text="+"  OnClick="Button2_Click" ></asp:Button>
    ...
    <footer style="background-image:url(images/back.jpg); height:10px">
		<div class="container_16">
			<nav>
				<ul>
					<li><a href="Default.aspx">Homee</a></li>
					<li><a href="#">How it works</a></li>
					<li><a href="#">About Us</a></li>
					<li><a href="Default2.aspx">Sign in</a></li>
