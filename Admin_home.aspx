<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_home.aspx.cs" Inherits="ff_site_Admin_page" %>
	...
	<header style="height:750px">
		<div class="container_16">
			...
			<div id="faded">
                ...
                <ul class="pagination" style="margin-top:75px;margin-left:100px;margin-top:70px"><div style="width:280px;height:340px; overflow:hidden;"><h3><center><font color="red">RECENT NEWS</font></center></h3><br/>
                   <article class="last">
						<ul class="img-list clearfix">
							<li ><a href="www.google.com"><img src="images/Copy1.jpg" alt=""><font color="black">Balochistan Earthquake<br/> Report</font></a></li><br />
